...
background: #f7f7f7;padding:10px" src="<?php echo WEBLIZAR_LBS_PLUGIN_URL."/images/nivo.jpg"; ?>" alt=""/>
				</div>
				<div class="col-sm-4 col-xs-4">
...
background: #f7f7f7;padding:10px" class="img-responsive" src="<?php echo WEBLIZAR_LBS_PLUGIN_URL."/images/photobox.jpg"; ?>" alt=""/>
				</div>
				<div class="col-sm-4 col-xs-4">
					<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Pretty Photo</h2>
					<img style="border: 1px solid #e3e3e3;
background: #f7f7f7;padding:10px" class="img-responsive" src="<?php echo WEBLIZAR_LBS_PLUGIN_URL."/images/prettyphoto.jpg"; ?>" alt=""/>
				</div>
				<div class="col-sm-4 col-xs-4">
					<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Window Box</h2>
					<img style="border: 1px solid #e3e3e3;
background: #f7f7f7;padding:10px" class="img-responsive" src="<?php echo WEBLIZAR_LBS_PLUGIN_URL."/images/window.jpg"; ?>" alt=""/>
				</div>
				<div class="col-sm-4 col-xs-4">
					<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Smooth Box</h2>
					<img style="border: 1px solid #e3e3e3;
background: #f7f7f7;padding:10px" class="img-responsive" src="<?php echo WEBLIZAR_LBS_PLUGIN_URL."/images/smooth.jpg"; ?>" alt=""/>
				</div>
				<div class="col-sm-4 col-xs-4">
					<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Swipe Box</h2>
					<img style="border: 1px solid #e3e3e3;
background: #f7f7f7;padding:10px" class="img-responsive" src="<?php echo WEBLIZAR_LBS_PLUGIN_URL."/images/swipebox.jpg"; ?>" alt=""/>
				</div>
				<div class="col-sm-4 col-xs-4">
					<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Ion Box</h2>
					<img style="border: 1px solid #e3e3e3;
background: #f7f7f7;padding:10px" class="img-responsive" src="<?php echo WEBLIZAR_LBS_PLUGIN_URL."/images/ion.jpg"; ?>" alt=""/>
				</div>
				<div class="col-sm-4 col-xs-4">
					<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Fancy Box</h2>
					<img style="border: 1px solid #e3e3e3;
background: #f7f7f7;padding:10px" class="img-responsive" src="<?php echo WEBLIZAR_LBS_PLUGIN_URL."/images/fancy.jpg"; ?>" alt=""/>
				</div>
